          ...
          if (widget.cartItem.itemData != null)
            ...List.generate(
              ...
              (index) {
                ...
                String display = get(itemData, ['display'], '');

                String text = display == '' ? value : display;
                ...
                return RichText(
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      TextSpan(
                          text: StringParse(text).unescape,
                          style: textTheme.bodySmall?.copyWith(color: textTheme.titleMedium?.color)),
                    ],
                  ),
                );
              },
