...
class Routes {
  ...
  static routes(SettingStore store) => <String, WidgetBuilder>{
        ...
        ChatBuddyUserList.routeName: (context) => ChatBuddyUserList(store: store),
        ChatBuddyMessageList.routeName: (context) => ChatBuddyMessageList(store: store),
        ChatBuddyGroupList.routeName: (context) => ChatBuddyGroupList(store: store),
      };
  ...
  static onGenerateRoute(RouteSettings settings, SettingStore store) {
    ...
    switch (name) {
      case PostListScreen.routeName:
        return _getPageRoute(screen: PostListScreen(args: args), routeName: name);
      ...
      case ChatBuddyUserDetail.routeName:
        return _getPageRoute(screen: ChatBuddyUserDetail(store: store, args: args), routeName: name);
      case ChatBuddyMessage.routeName:
        return _getPageRoute(screen: ChatBuddyMessage(store: store, args: args), routeName: name);
      case ChatBuddyGroupDetail.routeName:
        return _getPageRoute(screen: ChatBuddyGroupDetail(store: store, args: args), routeName: name);
      default:
        return null;
    }
  }
