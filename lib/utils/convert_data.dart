...
class ConvertData {
  ...
  static String? stringFromConfigs([dynamic value, String? language = defaultLanguage]) {
    if (value is String) {
      return value;
    }
  ...
  static String? imageFromConfigs([dynamic value, String? language = defaultLanguage]) {
    if (value is String) {
      return value;
    }
    if (value is Map<String, dynamic>) {
  ...
  static EdgeInsetsDirectional space(
    ...
    return EdgeInsetsDirectional.only(
      ...
      bottom: catchNegativeValue(ConvertData.stringToDouble(data['${key}Bottom'])),
    );
  }
  ...
  static BorderRadius corn(
    ...
    if (data is double || data is int || data is String) return BorderRadius.circular(ConvertData.stringToDouble(data));
    ...
    return BorderRadius.only(
      ...
      bottomLeft: Radius.circular(ConvertData.stringToDouble(data['bottomLeft'])),
      bottomRight: Radius.circular(ConvertData.stringToDouble(data['bottomRight'])),
    );
  }
